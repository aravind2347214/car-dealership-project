...
function DealerLocatorPage(props) {
  ...
  return (
    ...
    <div className='mt-20 w-[95%] mx-auto relative'>
    {
      ...
      <div className='text-[50px] font-extrabold text-[#7289DA] text-left' data-aos="fade-in">
        Locate a Dealer
      </div>
      <div className='flex flex-row justify-between p-1'>
        <form className='flex flex-col w-[35%] gap-2 p-2 ' onSubmit={handleSubmit}>
          ...
          <div className='flex justify-end py-1 '>
            <button type="submit" 
            data-aos="fade-up"
            className=' px-[32px] py-[8px] bg-[#7289DA] hover:shadow-lg hover:scale-105 rounded-md font-semibold text-white'>Connect With Dealer</button>
          </div>
         </form>
      <div 
      data-aos="fade-down"
      className='flex overflow-hidden border-2 border-[#7289DA] rounded-md h-[80%] w-1/2'>
